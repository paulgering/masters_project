...
p <- ggplot(data = my_table1, 
  ...
  geom_hline(yintercept = 0, linetype = "dotted", color = "black") + # drawing a dotted line at the 0 point on the y axis
  geom_pointrange() + # drawing a line between the lower and upper bound for each predictor
  ...
  theme(axis.title.x = element_text(size = 10, margin = margin(t = 15)), 
        ...
        plot.title = element_text(size = 12, hjust = 0.68)) #Set the plot margins and the distance between the axis and the labels 
...
Repo: https://github.com/paulgering/masters_project
